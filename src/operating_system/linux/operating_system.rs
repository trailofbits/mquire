...
impl LinuxOperatingSystem {
    ...
    /// Returns the decoded ptrace state for the task at the given virtual address
    pub fn task_ptrace(&self, vaddr: VirtualAddress) -> Result<TaskPtraceState> {
        self.task_ptrace_impl(vaddr)
    }
